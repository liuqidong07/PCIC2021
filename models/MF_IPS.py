...
class MF_IPS(nn.Module):
    def __init__(self, num_users, num_items, embedding_size, device):
    ...
    def calculate_loss(self, user_list, item_list, label_list, ps):
        return self.loss(self.forward(user_list, item_list), label_list, ps)
